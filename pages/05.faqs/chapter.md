...
[ui-accordion independent=true open=none][ui-accordion-item title="How can I migrate my eDoc Organizer Home Edition data to the On-Premise Edition?"]
...
[ui-accordion independent=true open=none][ui-accordion-item title="How can I get an invoice / payment receipt for my eDoc Organizer Cloud Service subscription?"]
...
3. This will show you a payment receipt for the selected transaction. This page can be printed for your records or to be submitted to your accounting department.[/ui-accordion-item][/ui-accordion]

[ui-accordion independent=true open=none][ui-accordion-item title="How do I make changes to my eDoc Organizer Cloud sevice plan?"]
...
4. Copy this security code in the Change Account Plan form, change the plan according to your new needs, read and agree to the prorated charge and then click the 'Change Plan' button to change your subscription plan.[/ui-accordion-item][/ui-accordion]

[ui-accordion independent=true open=none][ui-accordion-item title="How can I change the billing information (Credit Card) for my eDoc Organizer Cloud Service Account?"]
...
_If your account is past due, your new credit card will be billed automatically for the past due charges and your account will be automatically activated._[/ui-accordion-item][/ui-accordion]

[ui-accordion independent=true open=none][ui-accordion-item title="How do I Cancel eDoc Organizer Cloud Service Account?"]
...
5. You will receive a final confirmation email stating that your account is closed. [/ui-accordion-item][/ui-accordion]

[ui-accordion independent=true open=none][ui-accordion-item title="How can I migrate my eDoc Organizer Home Edition data to the Cloud Edition?"]
...
[notice]Note: Depending upon your internet connection upload speed it might take a few hours to upload your documents. The upload should not be interrupted as you might end up with duplicate data if you run the utility more than once.  If there is an error during the upload, it is recommended that you delete the data in your cloud account before re-running the utility.[/notice][/ui-accordion-item][/ui-accordion]

[ui-accordion independent=true open=none][ui-accordion-item title="eDoc Organizer Advanced Search Syntax"]
...
This eliminates any confusion and makes sure you that invoice must exist and either term 123456 or 896574 may exist.[/ui-accordion-item][/ui-accordion]
[/ui-tab][/ui-tabs]